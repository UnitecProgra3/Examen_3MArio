...
void ejercicio4(int i,int j,int k,int l)
{
    ...
    //-Asignar los siguientes valores:
    //	m = el int* en el achivo en la posicion i
    //	n = el int* en el achivo en la posicion j
    //	o = el int* en el achivo en la posicion k
    //	p = el int* en el achivo en la posicion l
